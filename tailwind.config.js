...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'flower-pattern':
          'url(\'data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23D9A6B3" fill-opacity="0.3"%3E%3Ccircle cx="30" cy="30" r="8"%3E%3C/circle%3E%3C/g%3E%3C/g%3E%3C/svg%3E\')',
      },
    },
  },
  plugins: [],
